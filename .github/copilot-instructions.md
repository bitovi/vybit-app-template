...
- **implement-feature**: **ALWAYS load this skill before making ANY UI change in the mock-app** — new pages, new components, editing existing pages, adding navigation, or any other UI work. No exceptions, even for "small" or "simple" changes. This skill ensures components are extracted, stories are created, and the registry is updated.
